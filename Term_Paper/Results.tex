...
As a result the threshold of OpernFace should be set to $0.71$ to fight off morphing attacks, in fact the biometric false rejection rate in the biometric system is acceptable.