...
As a result a threshold is computed to get a $10$\% false accept and a $90$\% chance to right decline a morphed image.\todo{richtige Bezeichnungen raussuchen}
...
\begin{figure}[htbp] 
	...
	\caption{Squared l2 euclidean distances (y axis) of the subset of 39 morphs (with 15 steps on the x axis) compared to the corresponding compare photos, in contrast to the calculated threshold of $0.76891524$} %\todo{beschreibung anpassen}
...
\begin{figure}[htbp] 
	...
	\caption{Squared l2 euclidean distances (y axis) of the subset of 8 manual morphs (with 30 steps on the x axis) compared to the corresponding compare photos, in contrast to the calculated threshold of $0.7172467154$} %\todo{beschreibung anpassen}
